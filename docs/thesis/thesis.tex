...
\begin{titlepage}
  ...
  {\Large\scshape A Technical Thesis\par}
  \vspace{2.2cm}
  ...
  \vspace{0.2cm}
  {\normalsize\href{mailto:\thesisemail}{\thesisemail}\par}
...
\section{The File Manager as a Systems Problem}
...
\subsection{Heterogeneous storage providers}
...
\subsection{Latency and progressive feedback}
...
\subsection{Ownership across asynchronous and platform boundaries}
