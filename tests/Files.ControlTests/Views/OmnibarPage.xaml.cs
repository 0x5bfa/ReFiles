...
namespace Files.ControlTests.Views
{
	...
	{
		private readonly ObservableCollection<OmnibarPaletteSuggestionItem> _omnibar1PaletteSuggestions;
		private readonly ObservableCollection<BreadcrumbBarItemModel> _omnibar1BreadcrumbBarItems;

		private string Omnibar1_TextMemberPathForPaletteMode => nameof(OmnibarPaletteSuggestionItem.Title);
		...
		{
			Omnibar1_ChosenSuggestionIndex = args.Item is OmnibarPaletteSuggestionItem item ? _omnibar1PaletteSuggestions.IndexOf(item) : -1;
		...
		{
			Omnibar1_ChosenSuggestionIndex = args.SelectedItem is OmnibarPaletteSuggestionItem item ? _omnibar1PaletteSuggestions.IndexOf(item) : -1;
			Omnibar1_SubmittedQuery = args.Mode.Text ?? string.Empty;
		}
	}
}
