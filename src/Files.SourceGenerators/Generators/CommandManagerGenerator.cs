	...
	internal sealed class CommandManagerGenerator : IIncrementalGenerator
	{
		public void Initialize(IncrementalGeneratorInitializationContext context)
		{
			...
			var commandGroups = context.SyntaxProvider.CreateSyntaxProvider(
				...
				.Collect()
				.Select(static (groups, token) => groups .Distinct(StringComparer.Ordinal) .OrderBy(static group => group, StringComparer.Ordinal) .ToImmutableArray());
		...
		private static string GenerateCommandManager(ImmutableArray<string> commandNames)
		{
			...
			builder.Append("""  private static ImmutableArray<IRichCommand> CreateCommands() => [ new NoneCommand(),  """);
