...
public static class AppCommandRegistration
{
	...
	private static void RegisterNavigation(CommandRegistryBuilder builder)
	{
		...
		builder.Register(new(CommandIds.TogglePreviewPane, Strings.TogglePreviewPane, "App.ThemedIcons.PanelRight", Strings.Navigation, 6), static _ => new PaneCommandHandler(CommandIds.TogglePreviewPane));
