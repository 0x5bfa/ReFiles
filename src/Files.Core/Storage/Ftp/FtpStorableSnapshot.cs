...
/// </summary>
internal sealed record FtpStorableSnapshot(FtpPath Path, string Name, FtpEntryKind Kind, long? Size, DateTimeOffset? DateModified, DateTimeOffset? DateCreated, string? LinkTarget)
{
