...
public static class ArchiveFilesCoreBuilderExtensions
{
		...
		IArchiveCredentialResolver? credentialResolver = null)
	{
		...
		builder.ItemFeatures
			.SetCombiner<IArchiveSource>(new PriorityItemFeatureCombiner<IArchiveSource>())
			.Add<IArchiveSource>(new ArchiveSourceFactory(), priority: 100, origin: "Archive browsing");
