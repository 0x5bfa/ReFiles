...
```xml
<PackageReference Include="ReFiles.Core" Version="0.1.0-alpha" />
```
...
Documentation and source are available in the [ReFiles repository](https://github.com/0x5bfa/ReFiles).
